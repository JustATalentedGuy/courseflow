...
async def get_course_status(db: AsyncSession, user_id: UUID, course_id: UUID) -> dict:
    ...
    return {
        ...
        "waiting_for_metadata": counts.get(VideoStatus.WAITING_FOR_METADATA.value, 0),
        "waiting_for_transcript": counts.get(VideoStatus.WAITING_FOR_TRANSCRIPT.value, 0),
        "transcribing": counts.get(VideoStatus.TRANSCRIBING.value, 0),
